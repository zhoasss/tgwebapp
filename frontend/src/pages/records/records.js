...
import { showNotification } from '../../shared/lib/telegram.js?v=3.0.3';
import { getAppointments } from '../../shared/lib/profile-api.js?v=3.0.3';
import pageLoader from '../../shared/ui/loader/loader.js?v=3.0.3';
import { API_BASE_URL } from '../../shared/config/api.js?v=3.0.3';
// We need to check cookie, not localStorage
import { getCookie } from '../../shared/lib/cookies.js?v=3.0.3';
